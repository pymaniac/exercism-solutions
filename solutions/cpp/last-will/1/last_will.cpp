...
namespace estate_executor {
    ...
    int assemble_code(void) {
        int red_part = garcia::red::code_fragment() + khan::red::code_fragment() + zhang::red::code_fragment();
        int blue_part = garcia::blue::code_fragment() + khan::blue::code_fragment() + zhang::blue::code_fragment();
